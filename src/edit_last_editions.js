...
const EditLastEditions = () => {
  ...
  useEffect(() => {
      ...
      const fetchData = async () => {
        try {
          ...
          setImg(data.bg_img || default_img);
          SetOldImg(data.bg_img || default_img)
  ...
  try {
    ...
    await addCostumInfo(doc, primaryColor, secondaryColor, thirdColor, url_res);
  ...
  return (
    <>  
        <div className="bg" id="background" style={{background: `url(${img})`, backgroundPositionX: "50%", backgroundPositionY: "50%", backgroundSize: "cover"}}>
...
export default EditLastEditions;
